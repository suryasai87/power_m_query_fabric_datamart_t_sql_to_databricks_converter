"""Cost estimation endpoints: migration, storage, compute, compare."""
from fastapi import APIRouter, HTTPException

from app.config import (
    AVAILABLE_MODELS, DBU_RATE_SERVERLESS, STORAGE_RATE_GB_MONTH,
    NETWORK_TRANSFER_RATE_GB, WAREHOUSE_DBU_RATES
)
from app.models import (
    MigrationCostEstimateRequest, MigrationCostEstimateResponse,
    CostBreakdown, CostComparisonRequest,
)
from app.utils import calculate_llm_cost, estimate_sql_tokens

router = APIRouter()


@router.post("/estimate/migration", response_model=MigrationCostEstimateResponse)
        ...
        for model_key, model_info in AVAILABLE_MODELS.items():
            ...
            model_comparisons.append({
                ...
                "total_migration_cost": round(
                    model_llm_cost +
                    migration_estimate.breakdown.compute_migration +
                    migration_estimate.breakdown.network_transfer, 2
                )
            })
